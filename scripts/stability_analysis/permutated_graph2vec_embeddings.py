...
def run_graph2vec_for_permutated_dataset(name: str):
    ...
    for dim in EMBEDDING_DIMS:
        ...
        metrics_rows.append({"dataset": name,"method": "Graph2Vec_permutated","dim": dim, "n_graphs": len(graphs), "fit_time_s": round(fit_time, 4), "embed_time_s": round(embed_time, 4), "total_time_s": round(total_time, 4),"rss_before_mb": round(rss_before_mb, 2), "rss_after_mb": round(rss_after_mb, 2),"peak_tracemalloc_mb": round(peak_mb, 2), })
